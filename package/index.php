...
<html lang="en">
		...
		<li><a href="Upload/client.html" class="btn btn-warning" style="color:#FFFFFF">Become Our Client</a></li>
           ...
           <div class="container">  
                ...
                <div class="table-responsive" style="margin-right:20px; !important; float:right">  
                     <h3 align="center">The Packages That You Provide</h3><br /> 
 ...
 $(document).ready(function(){  
      ...
      $(document).on('click', '#btn_add', function(){  
		   ...
		   if(detail == '')  
           {  
                alert("Enter Detail Of The Package");  
                return false;  
           } 
           if(price == '')  
           {  
           ...
           $.ajax({  
                url:"insert.php",  
                method:"POST",  
                data:{package_name:package_name, detail:detail, price:price},  
                dataType:"text",  
                success:function(data)  
                {  
                     alert(data);  
      ...
      $(document).on('blur', '.package_name', function(){  
           ...
           edit_data(id, package_name, "package_name");  
      });
